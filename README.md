...
| Week 1 | 1/5 | Basics: Logistic Regression and Naive Bayes [[Slides]](http://web.cs.ucla.edu/~yzsun/classes/2022Winter_CS247/Slides/02NaiveBayes_LR.pdf)| <ul><li>[Naive Bayes] (http://pages.cs.wisc.edu/~jerryzhu/cs769/nb.pdf) </li>
<li>[Newton Raphson Algorithm] (https://www.stat.washington.edu/adobra/classes/536/Files/week1/newtonfull.pdf)</li>
<li>[Discriminative vs. generative] (https://ai.stanford.edu/~ang/papers/nips01-discriminativegenerative.pdf)</li></ul>| ------ | ------ | ------ |
